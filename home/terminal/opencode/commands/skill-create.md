...
Analyze your repository's git history to extract coding patterns and generate SKILL.md files that teach your team's practices.
...
3. **Generates SKILL.md** - Creates valid Code skill files
