...
in {
  ...
  bind = [
    ...
    "$mod, Y, exec, ${settings.script.volume} up"
    "$mod, U, exec, ${settings.script.volume} down"
    "$mod SHIFT, Y, exec, ${settings.script.brightness} up"
    "$mod SHIFT, U, exec, ${settings.script.brightness} down"
